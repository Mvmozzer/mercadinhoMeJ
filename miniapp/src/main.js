import { initTelegram, telegramUserId } from './telegram.js?v=2026.07.13.431';
import {
  atualizarStatusLoja,
  authenticateBridge,
  ...
  loadCustomer,
  loadHealth
} from './api.js?v=2026.07.13.431';
import { createRenderer } from './render.js?v=2026.07.13.431';
import { createState, applySnapshot, normalizeMiniAppUi, loyaltyProgramEnabled, setRuntimeOnline } from './state.js?v=2026.07.13.431';
import { normalizeCatalog } from './catalog.js?v=2026.07.13.431';
import { reconcileCartWithCatalog, restoreCart } from './cart.js?v=2026.07.13.431';
import { loadLoyalty } from './loyalty.js?v=2026.07.13.431';
import { loadOrders } from './orders.js?v=2026.07.13.431';
