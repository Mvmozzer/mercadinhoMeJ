import { cartPayload } from './cart.js?v=2026.07.09.131';
import { retryApiFetchWithFreshRuntimeConfig } from './api.js?v=2026.07.09.131';
import { fallbackSendData } from './telegram.js?v=2026.07.09.131';
