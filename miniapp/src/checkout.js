import { cartPayload } from './cart.js?v=2026.08.01.397';
import { retryApiFetchWithFreshRuntimeConfig } from './api.js?v=2026.08.01.397';
import { fallbackSendData, telegramPayloadBytes, TELEGRAM_SEND_DATA_MAX_BYTES } from './telegram.js?v=2026.08.01.397';
