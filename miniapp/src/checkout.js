import { cartPayload } from './cart.js?v=2026.07.02.837';
import { retryApiFetchWithFreshRuntimeConfig } from './api.js?v=2026.07.02.837';
import { fallbackSendData } from './telegram.js?v=2026.07.02.837';
