import { cartPayload } from './cart.js?v=2026.07.12.576';
import { retryApiFetchWithFreshRuntimeConfig } from './api.js?v=2026.07.12.576';
import { fallbackSendData, telegramPayloadBytes, TELEGRAM_SEND_DATA_MAX_BYTES } from './telegram.js?v=2026.07.12.576';
