import { restoreMiniAppUiState } from './storage.js?v=2026.08.03.282';
import { normalizeWholesaleConfig } from './catalog.js?v=2026.08.03.282';
...
export function createState() {
  ...
  return {
    ...
    deliveryModeInitialized: false,
    checkoutAddress: {},
    checkoutPreview: null,
    checkoutPreviewPending: false,
